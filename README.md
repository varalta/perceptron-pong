...
Nosso artigo, redigido após nossas implementações e testes, pode ser acessado aqui: [Aplicação de uma rede perceptron no jogo Pong](https://github.com/varalta/perceptron-pong/blob/main/artigo.pdf).
